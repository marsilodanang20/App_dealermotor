...
?>
    ...
    if($msg===true){ 
        ...
        echo '<meta http-equiv="refresh" content="3;url='.base_url().'produk/">';
    } elseif($msg===false) {
    ...
    <h2><strong>produk</strong> <small>Delete Data</small> </h2>
    </div>
    <hr/>
    <form name="formDelete" method="POST" action="">
        ...
        <?php foreach ($rows as $row): ?>
                            ...
                            <dt class="col-sm-3">Kode_produk:</dt><dd class="col-sm-9"><?php echo $row['kode_produk']; ?></dd>
            
                            <dt class="col-sm-3">Nama_produk:</dt><dd class="col-sm-9"><?php echo $row['nama_produk']; ?></dd>
